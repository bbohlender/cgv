...
import { replace, insert, Selections, EditorResult as EditorState } from "."
...
export function removeValue(selections: Selections, grammar: HierarchicalParsedGrammarDefinition): EditorState {
