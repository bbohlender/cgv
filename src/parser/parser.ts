...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "Step", "symbols": [(lexer.has("openBracket") ? {type: "openBracket"} : openBracket), "Steps", "ws", (lexer.has("closedBracket") ? {type: "closedBracket"} : closedBracket)], "postprocess": ([,steps]) => ({ type: "bracket", steps: steps })},
    ...
    {"name": "GreaterOperation", "symbols": ["RelationalOperation", "ws", (lexer.has("greater") ? {type: "greater"} : greater), "ws", "ArithmeticOperation"], "postprocess": ([op1,,,,op2]) => ({ type: "operation", parameters: [op1, op2], identifier: ">" })},
    {"name": "GreaterEqualOperation", "symbols": ["RelationalOperation", "ws", (lexer.has("greaterEqual") ? {type: "greaterEqual"} : greaterEqual), "ws", "ArithmeticOperation"], "postprocess": ([op1,,,,op2]) => ({ type: "operation", parameters: [op1, op2], identifier: ">=" })},
