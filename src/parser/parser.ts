...
const grammar: Grammar = {
    ...
    ParserRules: [
        ...
        {
            name: "SequentialStep",
            symbols: ["ws", lexer.has("arrow") ? { type: "arrow" } : arrow, "ws", "PrimarySteps"],
        ...
        { name: "BooleanOperation", symbols: ["OrOperation"], postprocess: ([value]) => value },
        {
            ...
            postprocess: ([op1, , , , op2]) => ({ type: "or", children: [op1, op2] }),
        },
        { name: "OrOperation", symbols: ["AndOperation"], postprocess: ([value]) => value },
        {
            ...
            postprocess: ([op1, , , , op2]) => ({ type: "and", children: [op1, op2] }),
        },
        { name: "AndOperation", symbols: ["NegateOperation"], postprocess: ([value]) => value },
        {
            ...
            postprocess: ([, , op1]) => ({ type: "not", children: [op1] }),
        },
        ...
        { name: "EquityOperation", symbols: ["RelationalOperation"], postprocess: ([value]) => value },
        {
            ...
            symbols: [
                "EquityOperation",
                "ws",
                lexer.has("doubleEqual") ? { type: "doubleEqual" } : doubleEqual,
                "ws",
                "RelationalOperation",
            ],
            postprocess: ([op1, , , , op2]) => ({ type: "equal", children: [op1, op2] }),
        },
        {
            ...
            postprocess: ([op1, , , , op2]) => ({ type: "unequal", children: [op1, op2] }),
        },
        ...
        { name: "RelationalOperation", symbols: ["ArithmeticOperation"], postprocess: ([value]) => value },
        {
            ...
            postprocess: ([op1, , , , op2]) => ({ type: "smaller", children: [op1, op2] }),
        },
        {
            ...
            postprocess: ([op1, , , , op2]) => ({ type: "smallerEqual", children: [op1, op2] }),
        },
        {
            ...
            postprocess: ([op1, , , , op2]) => ({ type: "greater", children: [op1, op2] }),
        },
        {
            ...
            postprocess: ([op1, , , , op2]) => ({ type: "greaterEqual", children: [op1, op2] }),
        },
        ...
        { name: "PointOperation", symbols: ["InvertOperation"], postprocess: ([value]) => value },
        {
            ...
            postprocess: ([op1, , , , op2]) => ({ type: "divide", children: [op1, op2] }),
        },
        {
            ...
            postprocess: ([op1, , , , op2]) => ({ type: "multiply", children: [op1, op2] }),
        },
        {
            ...
            postprocess: ([op1, , , , op2]) => ({ type: "modulo", children: [op1, op2] }),
        },
        {
            name: "InvertOperation",
            symbols: [lexer.has("minus") ? { type: "minus" } : minus, "ws", "InvertOperation"],
            postprocess: ([, , op1]) => ({ type: "invert", children: [op1] }),
        },
        ...
        { name: "Random$ebnf$1", symbols: ["RandomStep"] },
        { name: "Random$ebnf$1", symbols: ["Random$ebnf$1", "RandomStep"], postprocess: (d) => d[0].concat([d[1]]) },
        {
            ...
            postprocess: ([, steps]) => ({
                type: "random",
                probabilities: steps.map(({ probability }: any) => probability),
                children: steps.map(({ steps }: any) => steps),
            }),
        },
        {
            name: "RandomStep",
            ...
            postprocess: ([, { value }, , , , , steps]) => ({ probability: Number.parseFloat(value) / 100, steps }),
        },
        {
            name: "Operation",
            symbols: [
        ...
        },
        {
            ...
            postprocess: ([, , { value: identifier }]) => ({ type: "getVariable", identifier }),
        },
        {
            name: "SetVariable",
            symbols: [
            ...
            postprocess: ([, , { value: identifier }, , , , value]) => ({
                type: "setVariable",
                identifier,
                children: [value],
            }),
        ...
        { name: "Switch$ebnf$1", symbols: ["SwitchCase"] },
        { name: "Switch$ebnf$1", symbols: ["Switch$ebnf$1", "SwitchCase"], postprocess: (d) => d[0].concat([d[1]]) },
        {
            name: "Switch",
            symbols: [
