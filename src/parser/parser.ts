...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "Variable", "symbols": [(lexer.has("thisSymbol") ? {type: "thisSymbol"} : thisSymbol), (lexer.has("point") ? {type: "point"} : point), (lexer.has("identifier") ? {type: "identifier"} : identifier)], "postprocess": ([,,{ value }]) => ({ type: "raw", value })},
    {"name": "GetVariable", "symbols": ["Variable"], "postprocess": ([name]) => ({ type: "getVariable", children: [name] })},
    {"name": "SetVariable", "symbols": ["Variable", "ws", (lexer.has("equal") ? {type: "equal"} : equal), "ws", "Step"], "postprocess": ([name,,,,value]) => ({ type: "setVariable", children: [name, value] })},
