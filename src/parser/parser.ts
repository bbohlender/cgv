...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "Step", "symbols": ["Variable"], "postprocess": () => ({})},
    ...
    {"name": "Constant", "symbols": [(lexer.has("string") ? {type: "string"} : string)], "postprocess": ([{ value }]) => value},
    ...
    {"name": "Variable", "symbols": [(lexer.has("thisSymbol") ? {type: "thisSymbol"} : thisSymbol), (lexer.has("point") ? {type: "point"} : point), (lexer.has("identifier") ? {type: "identifier"} : identifier)]},
    {"name": "AssignVariable", "symbols": ["Variable", "ws", (lexer.has("equal") ? {type: "equal"} : equal), "Steps"]},
    ...
    {"name": "IfThenElseOperation", "symbols": [(lexer.has("ifSymbol") ? {type: "ifSymbol"} : ifSymbol), "Steps", "ws", (lexer.has("thenSymbol") ? {type: "thenSymbol"} : thenSymbol), "Steps", "ws", (lexer.has("elseSymbol") ? {type: "elseSymbol"} : elseSymbol), "Steps"], "postprocess": ([,value,,,ifOperation,,,elseOperation]) => ({ type: "operation", parameters: [value, ifOperation, elseOperation], identifier: "if" })},
    ...
    {"name": "SwitchOperation", "symbols": [(lexer.has("switchSymbol") ? {type: "switchSymbol"} : switchSymbol), "Steps", "SwitchOperation$ebnf$1"], "postprocess": ([,value,cases]) => ({ type: "operation", parameters: [value, ...cases.reduce((v1: Array<any>, v2: Array<any>) => v1.concat(v2))], identifier: "switch" })},
    {"name": "SwitchCase", "symbols": ["ws", (lexer.has("caseSymbol") ? {type: "caseSymbol"} : caseSymbol), "Steps", "ws", (lexer.has("colon") ? {type: "colon"} : colon), "Steps"], "postprocess": ([,,value,,,operation]) => [value, operation]},
    ...
    {"name": "InvertOperation", "symbols": [(lexer.has("openBracket") ? {type: "openBracket"} : openBracket), "Steps", "ws", (lexer.has("closedBracket") ? {type: "closedBracket"} : closedBracket)], "postprocess": ([,steps]) => steps}
  ],
