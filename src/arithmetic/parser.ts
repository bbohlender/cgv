...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "expression", "symbols": ["operation"], "postprocess": ([result]) => result},
    {"name": "expression", "symbols": ["decimal"], "postprocess": ([result]) => result},
    {"name": "operation$subexpression$1", "symbols": [{"literal":"+"}]},
    {"name": "operation$subexpression$1", "symbols": [{"literal":"-"}]},
    {"name": "operation$subexpression$1", "symbols": [{"literal":"*"}]},
    {"name": "operation$subexpression$1", "symbols": [{"literal":"/"}]},
    {"name": "operation", "symbols": ["expression", "operation$subexpression$1", "decimal"], "postprocess": 
